...
const ServiceCRUD = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch('http://192.168.1.152:3000/getListService');
        ...
        [
          ...
          },
          {
            ...
            onPress: async () => {
              ...
              await axios.delete(`http://192.168.1.152:3000/deleteservice/${id}`);
  ...
  const handleSave = async () => {
    try {
      ...
      await axios.put(
        `http://192.168.1.152:3000/updateservice/${editingNews._id}`,
        {
          name: editedName,
