    ...
    return (
        <View style={{flex:1}}>
            ...
            <View style={styles.container}>
                <View >
                    <Animated.Text style={{ ...styles.label2, opacity: opacity1,color:'blue' }}>
                        {text[0]}
                    </Animated.Text>
                    <View style={styles.text}>
                        <Animated.Text style={{ ...styles.label, opacity: opacity2,color:'red' }}>
                            {text[1]}
                        </Animated.Text>
                        <Animated.Text style={{ ...styles.label, opacity: opacity3,color:'red' }}>
                            {text[2]}
                        </Animated.Text>
                    </View>
